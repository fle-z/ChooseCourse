...
<!-- 顶部导航结束 -->
    ...
    <div class="row">
        <div class="col-xs-10 col-md-offset-1">
            <h2>选课学生</h2>
            <form class="form-search" style="float:right; width:20em; margin: 0.5em 2em;" method="POST" action="/ChooseCourse/index.php/Home/Course/viewChoice">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
              ...
              修改学生分数
                ...
                <form name="form" accept-charset="utf-8" id="form" class="form" action="<?php echo U('Course/updateScore');?>" method="post">
