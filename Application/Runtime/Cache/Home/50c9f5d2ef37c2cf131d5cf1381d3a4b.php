...
<head>
    ...
    <script type="text/javascript" src="/ChooseCourse/Application/Home/View/Public/js/login.js"></script>
    ...
    <link href="/ChooseCourse/Application/Home/View/Public/css/signin.css" rel="stylesheet">
    <link href="/ChooseCourse/Application/Home/View/Public/css/login2.css" rel="stylesheet" type="text/css" />
...
<body>
    <div class="login" style="margin-top:50px;">
        ...
        <div class="web_qr_login" id="web_qr_login" style="display: block; height: 370px;">
                ...
                <div class="login-box">
                    <div class="login_form">
                        <form name="form" accept-charset="utf-8" id="form" class="form-signin" action="<?php echo U('Login/check_login');?>" method="post">
                            ...
                            <input type="verify" id="inputVerify" class="form-control" name="verify" placeholder="验证码" required>
                            <img class="verify" src="<?php echo U('Login/verify');?>" alt="" name="verify" onClick="this.src=this.src+'?'+Math.random();"/>
                            <center>
        ...
        <div class="qlogin" id="qlogin" style="display: none; ">
            ...
            <div class="web_login">
                <form class="form-signin reg_form" id="regUser" accept-charset="utf-8" action="<?php echo U('Login/addUser');?>" method="post">
                    ...
                    <input type="class" id="inputClass" class="form-control" name="class_name" placeholder="班级名称" required>
                    <center>
