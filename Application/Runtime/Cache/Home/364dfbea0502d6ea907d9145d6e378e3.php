...
<!-- 顶部导航结束 -->
    ...
    <div class="row">
        <div class="col-xs-10 col-md-offset-1">
            <h2>学生信息</h2>
            <form class="form-search" style="float:right; width:20em; margin: 0.5em 2em;" method="POST" action="/ChooseCourse/index.php/Home/Boss/viewTeachers">
                <div class="input-group">
                    <input type="text" class="form-control" name="teacher" placeholder="查询" required>
    ...
    <div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
              ...
              修改老师信息
                ...
                <form name="form" accept-charset="utf-8" id="form" class="form" action="<?php echo U('Boss/updateTeachers');?>" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label">姓名</label>
                            <div class="col-sm-10" style="margin-bottom:10px;">
                                <input type="text" class="form-control" id="teacher_name" name="teacher_name" placeholder="请输入姓名">
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <script>
            function update(obj) {
                ...
                $('#teacher_name').val(tds.eq(0).text());
