...
<!-- 顶部导航结束 -->
    ...
    <div class="row">
        <div class="col-xs-10 col-md-offset-1">
            <h2>选课学生</h2>
            <form action="/ChooseCourse/index.php/Home/Course/setScore" method="post">
                        ...
                        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <div class="col-sm-4 col-sm-offset-0">
                                        <input type="text" class="form-control" id="score" name = "<?php echo ($data["number"]); ?>" placeholder="请输入成绩">
                                    </div>
                                </td>
